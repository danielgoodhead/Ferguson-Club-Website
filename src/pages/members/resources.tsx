  ...
  return (
    <>
      <SEO
        ...
        description="Access exclusive technical documentation, workshop manuals, parts catalogs, and historical archives."
      />
        ...
        <section className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="flex space-x-8 overflow-x-auto py-4">
              ...
              <Link href="/members/resources" className="text-[#8B1538] font-semibold whitespace-nowrap border-b-2 border-[#8B1538]">
                Resources
              </Link>
